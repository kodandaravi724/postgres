...
typedef struct BufferDesc
{
	...
	int      nextInLRU;          /*holds the buffer id next buffer in LRUQueue*/
	int      prevInLRU;			/*holds the buffer id previous buffer in LRUQueue*/
} BufferDesc;
...
/**
 * The lruNext field is either the index of next buffer in LRU queue, 
 * or one of these special values: Modified by Kodanda Ravi Kiran Putta
*/
...
extern void RemoveFromLRU_Locked(BufferDesc *b);
extern void RemoveFromLRU(int bufId);
...
extern void AddToTail(int bufId);
